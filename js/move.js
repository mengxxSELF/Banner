...
(function(){
    var searchEffect = {
        ...
        Bounce: {
            easeIn: function (t, b, c, d) {
                return c - searchEffect.Bounce.easeOut(d - t, 0, c, d) + b;
            },
            ...
            easeInOut: function (t, b, c, d) {
                if (t < d / 2) {
                    return searchEffect.Bounce.easeIn(t * 2, 0, c, d) * .5 + b;
                }
                return searchEffect.Bounce.easeOut(t * 2 - d, 0, c, d) * .5 + c * .5 + b;
            }
        },
        //二次方的缓动
        Quad: {
    ...
    //curEle  target  duration cb effect
    animate=function(opt){
        ...
        //运动形式
        var tmpEffect=searchEffect[defaultOpt.effect];
        ...
        if(typeof effect==='number'){
            ...
            ary=str.split('-');
            tmpEffect=ary.length>=2?searchEffect[ary[0]][ary[1]]:searchEffect[ary[0]];
        }else if(typeof effect=='object'){
            tmpEffect=effect.length>=2?searchEffect[effect[0]][effect[1]]:searchEffect[effect[0]];
        }
        //为公式的参数做准备；
        var begin={},change={};
